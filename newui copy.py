...
try:
    ...
    tk.Label(home, text="TNT LAUNCHER",
             fg="white", bg="#121212",
...
tk.Button(
    ...
    width=22,
    command=lambda: run_script("thevdowntest.exe")
).pack(pady=12)
...
tk.Button(
    ...
    font=("Segoe UI", 12, "bold"),
    width=22,
    command=lambda: run_script("install_fabric.exe")
).pack(pady=12)
...
tk.Button(
    ...
    font=("Segoe UI", 12, "bold"),
    width=22,
    command=lambda: run_script("install_fabric_api.exe")
).pack(pady=12)
...
tk.Button(
    ...
    fg="white",
    font=("Segoe UI", 12, "bold"),
    command=play_vanilla
).pack(side="left", padx=14, ipadx=26, ipady=10)
